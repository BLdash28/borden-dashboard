/**
 * cargar-unisuper-widget22.mjs
 * Carga widget (22).csv: Unisuper GT 2026 jun 23-27 (LA TORRE + ECONOSUPER).
 *
...
// Tasas diarias junio 2026 (1 GTQ = X USD). Para jun 23-27 usamos
...
const PATH = 'C:/Users/IAN/Downloads/widget (22).csv'
console.log(`\n📂 ${PATH.split('/').pop()}`)
