    ...
    return (
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
          {L ? Array(4).fill(0).map((_, i) => (
            <div key={i} className="bg-white rounded-xl border border-gray-100 shadow-sm p-5 animate-pulse">
              <div className="h-3 bg-gray-100 rounded w-2/3 mb-3" /><div className="h-7 bg-gray-100 rounded w-1/2 mb-2" /><div className="h-3 bg-gray-100 rounded w-1/3" />
            </div>
          )) : topCards.map(c => (
        ...
        {L ? (
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
            {Array(2).fill(0).map((_, i) => (
              <div key={i} className="bg-[#1b3b5f] rounded-xl p-5 animate-pulse">
                <div className="h-2 bg-white/10 rounded w-1/2 mb-3" />
                <div className="h-10 bg-white/10 rounded w-2/3 mb-2" />
                <div className="h-2 bg-white/10 rounded w-3/4 mb-5" />
                <div className="border-t border-white/10 pt-3 grid grid-cols-2 gap-4">
                  <div className="h-8 bg-white/10 rounded" /><div className="h-8 bg-white/10 rounded" />
                </div>
              </div>
            ))}
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
            ...
            <div className="bg-[#1b3b5f] rounded-xl p-5 text-white">
              <p className="text-[10px] font-semibold text-blue-200 uppercase tracking-widest mb-2">🔥 HOY · SELL-IN REAL YTD 2026</p>
              <p className="text-3xl font-bold mb-1">{fmtFull(sellin.ingresos.valor)}</p>
              <p className="text-xs text-blue-300 mb-4">{catBreak}</p>
              <div className="border-t border-white/10 pt-3 grid grid-cols-2 gap-4">
                <div>
                  <p className="text-[9px] uppercase tracking-widest text-blue-300 mb-1">Crecimiento YTD vs 2025</p>
                  {sellin.ingresos.delta >= 100 ? (
                    <>
                      <p className="text-sm font-bold text-yellow-300">Sin datos 2025</p>
                      <p className="text-[10px] text-blue-300 mt-0.5">+{fmtFull(sellin.ingresos.valor)} nuevo</p>
                    </>
                  ) : (
                    <p className="text-sm font-bold text-yellow-300">{growthText(sellin.ingresos.delta)}</p>
                  )}
                </div>
                <div>
                  <p className="text-[9px] uppercase tracking-widest text-blue-300 mb-1">Cumplimiento YTD vs Plan</p>
                  <p className="text-sm font-bold text-yellow-300">{cumplYTD !== null ? `${cumplYTD.toFixed(1)}%` : '—'}</p>
            ...
            {/* Proyección FY */}
            <div className="bg-[#1b3b5f] rounded-xl p-5 text-white">
              <p className="text-[10px] font-semibold text-blue-200 uppercase tracking-widest mb-2">📊 PROYECCIÓN · CIERRE FY 2026</p>
              <p className="text-3xl font-bold mb-1">{fmtFull(proyTotal)}</p>
              <p className="text-xs text-blue-300 mb-4">Plan completo · CALLEJA</p>
              <div className="border-t border-white/10 pt-3 grid grid-cols-2 gap-4">
                <div>
                  <p className="text-[9px] uppercase tracking-widest text-blue-300 mb-1">Crecimiento FY Esperado vs 2025</p>
                  <p className="text-sm font-bold text-yellow-300">N/A (sin 2025)</p>
                </div>
                <div>
                  <p className="text-[9px] uppercase tracking-widest text-blue-300 mb-1">Cumplimiento FY Proyectado</p>
                  <p className="text-sm font-bold text-yellow-300">{cumplFY !== null ? `${cumplFY.toFixed(1)}%` : '—'}</p>
                </div>
              </div>
            </div>
          </div>
        ...
        {L ? (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
            {/* Sell-Out Real YTD */}
            <div className="bg-[#1b3b5f] rounded-xl p-5 text-white">
              <p className="text-[10px] font-semibold text-blue-200 uppercase tracking-widest mb-2">🛒 HOY · SELL-OUT REAL YTD 2026</p>
              <p className="text-3xl font-bold mb-1">{fmtFull(selloutKpi.ytd_2026.total)}</p>
              <p className="text-xs text-blue-300 mb-4">
                {[
                  selloutKpi.ytd_2026.quesos > 0 ? `Queso ${fmtFull(selloutKpi.ytd_2026.quesos)}` : null,
                  selloutKpi.ytd_2026.leches > 0 ? `Leche ${fmtFull(selloutKpi.ytd_2026.leches)}` : null,
                ].filter(Boolean).join(' + ') || 'YTD 2026'}
              </p>
              <div className="border-t border-white/10 pt-3 grid grid-cols-2 gap-4">
                <div>
                  <p className="text-[9px] uppercase tracking-widest text-blue-300 mb-1">YTD 2026 vs YTD 2025</p>
                  {selloutKpi.ytd_2025.total <= 0 ? (
                    <p className="text-sm font-bold text-yellow-300">Sin datos 2025</p>
                  ) : (
                    <>
                      <p className="text-sm font-bold text-yellow-300">
                        {selloutKpi.delta_ytd > 0 ? '+' : ''}{selloutKpi.delta_ytd.toLocaleString('en-US', { maximumFractionDigits: 0 })}%
                      </p>
                ...
                <div>
                  <p className="text-[9px] uppercase tracking-widest text-blue-300 mb-1">FY 2025 (Referencia)</p>
            ...
            {/* Sell-Out Proyección FY */}
            <div className="bg-[#1b3b5f] rounded-xl p-5 text-white">
              <p className="text-[10px] font-semibold text-blue-200 uppercase tracking-widest mb-2">📈 ESTIMACIÓN · SELL-OUT FY 2026</p>
              <p className="text-3xl font-bold mb-1">{fmtFull(selloutKpi.fy_2026_est)}</p>
              <p className="text-xs text-blue-300 mb-4">Promedio mensual × 12 meses</p>
              <div className="border-t border-white/10 pt-3 grid grid-cols-2 gap-4">
                <div>
                  <p className="text-[9px] uppercase tracking-widest text-blue-300 mb-1">Crecimiento FY vs 2025</p>
                  {selloutKpi.delta_fy >= 100 || selloutKpi.fy_2025.total < 1000 ? (
                    <>
                      <p className="text-sm font-bold text-yellow-300">Sin hist. completo</p>
                      <p className="text-[10px] text-blue-300 mt-0.5">FY 2025 parcial</p>
                    </>
                  ) : (
                    <p className="text-sm font-bold text-yellow-300">
                      {selloutKpi.delta_fy > 0 ? '+' : ''}{(selloutKpi.delta_fy ?? 0).toFixed(1)}%
                    </p>
                  )}
                </div>
                <div>
                  <p className="text-[9px] uppercase tracking-widest text-blue-300 mb-1">Promedio Mensual</p>
                  <p className="text-sm font-bold text-yellow-300">
                    {fmtFull(selloutKpi.ytd_2026.total / (selloutKpi.ultimo_mes || 1))}
                  </p>
                  <p className="text-[10px] text-blue-300 mt-0.5">/mes ({selloutKpi.ultimo_mes} meses)</p>
                </div>
              </div>
            </div>
          </div>
        ...
        {/* Inventory KPI grid — 10 cards */}
        {!L && invKpis && (() => {
          const ik = invKpis
          const cards = [
            {
              label: 'INV PDV ($)',
              value: fmtFull(ik.pdv.valor),
              sub: `${ik.pdv.unidades.toLocaleString('en-US')} unidades`,
              icon: '📦',
            ...
            {
              label: 'INV CEDI ($)',
              value: fmtFull(ik.cedi.valor),
              sub: `${ik.cedi.unidades.toLocaleString('en-US')} u · ${ik.cedi.tiendas} CEDI`,
              icon: '🏭',
              bg: 'bg-white border-gray-100',
              tc: 'text-gray-800',
            },
            {
              label: 'TOTAL INV ($)',
              value: fmtFull(ik.total.valor),
              sub: `${ik.total.unidades.toLocaleString('en-US')} u totales`,
              icon: '💰',
              bg: 'bg-white border-gray-100',
              tc: 'text-gray-800',
            },
            {
              label: 'TIENDAS PDV',
              value: ik.pdv.tiendas,
              sub: `PDV · ${ik.cedi.tiendas} CEDI`,
              icon: '🏪',
              bg: 'bg-white border-gray-100',
              tc: 'text-gray-800',
            },
            ...
            {
              label: 'CRÍTICOS PDV',
              value: ik.critico_sala,
              sub: 'DOH < 7 días',
              icon: '🔴',
              bg: ik.critico_sala > 0 ? 'bg-red-50 border-red-200' : 'bg-white border-gray-100',
              tc: ik.critico_sala > 0 ? 'text-red-700' : 'text-gray-800',
            },
            {
              label: 'EN ALERTA PDV',
              value: ik.alerta_sala,
              sub: 'DOH 7–14 días',
              icon: '⚠️',
              bg: ik.alerta_sala > 0 ? 'bg-amber-50 border-amber-200' : 'bg-white border-gray-100',
              tc: ik.alerta_sala > 0 ? 'text-amber-700' : 'text-gray-800',
            },
            {
              label: 'SKUs A OFERTAR',
              value: ik.skus_ofertar,
              sub: 'DOH > 60 días',
              icon: '🔵',
              bg: ik.skus_ofertar > 0 ? 'bg-blue-50 border-blue-200' : 'bg-white border-gray-100',
              tc: ik.skus_ofertar > 0 ? 'text-blue-700' : 'text-gray-800',
            },
            {
              label: 'QUIEBRE CEDI',
              value: ik.quiebre_cedi,
              sub: 'SKUs sin stock CEDI',
              icon: '🚨',
              bg: ik.quiebre_cedi > 0 ? 'bg-purple-50 border-purple-200' : 'bg-white border-gray-100',
              tc: ik.quiebre_cedi > 0 ? 'text-purple-700' : 'text-gray-800',
            },
            {
              label: 'BASELINE MENSUAL',
              value: fmtFull(ik.baseline.valor_mes),
              sub: ik.baseline.meses_ref ? `Ref: ${ik.baseline.meses_ref}` : 'Promedio meses ≥$5K',
              icon: '📊',
              bg: 'bg-white border-gray-100',
              tc: 'text-gray-800',
            },
          ...
          return (
            <div>
              <p className="text-xs font-semibold text-gray-400 uppercase tracking-widest mb-3">Indicadores de Inventario</p>
              <div className="grid grid-cols-2 lg:grid-cols-5 gap-3">
                {cards.map(c => (
                  <div key={c.label} className={`rounded-xl border shadow-sm p-4 ${c.bg}`}>
                    ...
                    <p className="text-xs text-gray-600 font-semibold">{c.sub}</p>
                  </div>
                ))}
              </div>
            </div>
